...
REM MGT Wrapper
vlogcomp -work work  ..\..\..\xaui_wrapper_gtx.v
vlogcomp -work work  ..\..\..\xaui_wrapper.v



REM Example Design modules
vlogcomp -work work  ..\..\example_design\xaui_wrapper_tx_sync.v
vlogcomp -work work  ..\..\example_design\frame_gen.v
vlogcomp -work work  ..\..\example_design\frame_check.v
vlogcomp -work work  ..\..\example_design\xaui_wrapper_top.v
