...
COPY xaui_wrapper_top.edf .\results
cd .\results

REM Run ngdbuild

ngdbuild -uc ..\..\example_design\xaui_wrapper_top.ucf -p xc6vlx75tl-ff784-1l xaui_wrapper_top.edf xaui_wrapper_top.ngd
...
ECHO 'Running NGD'
map -p xc6vlx75tl-ff784-1l -o mapped.ncd xaui_wrapper_top.ngd
...
netgen -ofmt verilog -sim -sdf_path ../../implement/results -dir . -tm xaui_wrapper_top -w routed.ncd routed.v
