...
create_clock -name sys_clk -period 2 [get_ports sys_clk_p]
...
set_property LOC AB27 [get_ports {clk_ref_p}]

# PadFunction: IO_L12N_T1_MRCC_13 
set_property IOSTANDARD LVDS_25 [get_ports {clk_ref_n}]
set_property LOC AC27 [get_ports {clk_ref_n}]
